As of 20240510, this is a direct copy from [here](https://github.com/github/docs/blob/main/.github/CONTRIBUTING.md) as found through [here](https://docs.github.com/en/communities/setting-up-your-project-for-healthy-contributions/setting-guidelines-for-repository-contributors). Will update later. Setting up the repo.
